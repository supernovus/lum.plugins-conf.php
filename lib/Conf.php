...
/**
 * Lum Configuration Object
 *
 * It's based on the Data Objects framework,
 ...
 */
class Conf extends \Lum\Data\Arrayish
{
...
#      error_log("Data: ".json_encode($data));
  ...
  protected function load_file_chain ($filename, $type=Null)
  {
    ...
    if (is_array($data) && isset($data['@traits']) && Arrays::is_assoc($data['@traits']))
    {
